...
import svgRenderer from 'hanzi-writer-renderers/svg';
import canvasRenderer from 'hanzi-writer-renderers/canvas';
...
} from 'hanzi-writer-renderers/HanziWriterRendererBase';
