...
describe('CharacterRenderer', function () {
    ...
    it('renders a g element and puts strokes inside', function () {
        var props = {
    ...
    it('updates opacity and updates passed-through props', function () {
        ...
        var props2 = copyAndMergeDeep(props1, {
    ...
    it('sets display: none if opacity is 0', function () {
        var props1 = {
