...
describe('StrokeRenderer', function () {
    ...
    it('renders a path and clipPath', function () {
        ...
        var maskPath = target.defs.childNodes[0].childNodes[0];
        expect(maskPath.nodeName).toBe('path');
        var maskId = target.defs.childNodes[0].getAttribute('id');
        ...
        expect(target.svg.childNodes[1].getAttribute('clip-path')).toBe("url(\"https://test.com/url#".concat(maskId, "\")"));
